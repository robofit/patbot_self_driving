...
public:
  ...
  vector<double> patbot_front_frees_pace_;
  vector<double> patbot_right_frees_pace_;
  vector<double> patbot_left_frees_pace_;


  vector<double> patbot_front_right_frees_pace_;
  vector<double> patbot_front_left_frees_pace_;
